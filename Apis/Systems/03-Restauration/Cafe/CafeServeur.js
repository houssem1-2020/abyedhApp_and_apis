...
const CafeServeurRouter = express.Router()
...
/*####################################[LOGIN & LANDING ]###########################*/
	...
	/*log in*/
	CafeServeurRouter.post('/LogIn', (req, res) => {
		  const logInD = req.body.LoginData;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
		  let sql = `SELECT * FROM 05_cafe_team WHERE Identifiant = '${logInD.Log}' AND Password  = '${logInD.Pwd}'` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows[0])
	...
	CafeServeurRouter.post('/main/position', (req, res) => {
				...
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 05_cafe_caisses_position(Camion_ID,jour,heur,Position) VALUES ('${camId}','${Today}','${ToTime}','${position}') ON DUPLICATE KEY UPDATE jour = '${Today}',  heur = '${ToTime}' , Position = '${position}' ;`;
				connection.query(sql, (err, rows, fields) => {
					if (err) throw err
					res.json(rows);
				}); 
...
/*####################################[CAISSE SIMPLE ]#############################*/
	...
	CafeServeurRouter.post('/nv/stock', (req, res) => {
	...
	CafeServeurRouter.post('/nv/ajouter', (req, res) => {
		(async() => {
		  	    let PID = req.body.forPID;
				...
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 05_cafe_factures (PID,T_ID,Cre_Date,Camion,C_Name,Tota, Chauffeur,Articles) 
	...
	CafeServeurRouter.post('/nv/ajouter', (req, res) => {
		(async() => {
				...
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 05_cafe_factures (PID, T_ID,Caisse_ID,Final_Value,Espece, T_Date, T_Time,Client,State, Paye_Bons, Articles) 
	...
	/* modifier un facture */
	CafeServeurRouter.post('/nv/payee/espece', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	CafeServeurRouter.post('/nv/payee/bons', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	CafeServeurRouter.post('/nv/client/credit', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	CafeServeurRouter.post('/nv/client/fidelite', (req, res) => {
		  let PID = req.body.forPID;
		  let clientId = req.body.clientId
		  let FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* modifier un facture */
	CafeServeurRouter.post('/nv/openCaisse', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[MES FACT]###################################*/
	...
	/* selctioner mes 05_cafe_factures [in between] */
	CafeServeurRouter.post('/mf', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
		  let sql = `SELECT * 
		  			 FROM 05_cafe_factures 
		  			 LEFT JOIN 05_cafe_clients ON 05_cafe_factures.C_Name = 05_cafe_clients.CL_ID
		  			 WHERE 05_cafe_factures.Camion = ${camId} ORDER BY 05_cafe_factures.Cre_Date DESC LIMIT 50` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows);
	...
	/* selectioner une 05_cafe_factures */
	CafeServeurRouter.post('/mf/select', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  ...
		  let sql = `SELECT *
		  			 FROM 05_cafe_factures 
		  			 LEFT JOIN 05_cafe_clients ON 05_cafe_factures.C_Name = 05_cafe_clients.CL_ID
		  			 WHERE 05_cafe_factures.Camion =  ${camId}  AND 05_cafe_factures.F_ID = ${FID} ` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows);
	...
	/* modifier un facture */
	CafeServeurRouter.post('/mf/modifier', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[STOCK]######################################*/
	/*Suivie un article */
	CafeServeurRouter.post('/sk/suivie', (req, res) => {
		    let PID = req.body.forPID;
	...
	/*Selectionner Fonds */
	CafeServeurRouter.post('/sk/fonds', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	CafeServeurRouter.post('/sk/fonds/info', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  const FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/*Regler Ventes*/
	CafeServeurRouter.post('/sk/reglemment', (req, res) => {
		  let PID = req.body.forPID  
	...
	CafeServeurRouter.post('/sk/reglemment/check', (req, res) => {
		  let PID = req.body.forPID;
		  let camId = req.body.camId;
	...
	/*Regler Ventes*/
	CafeServeurRouter.post('/sk/reglemment/enregistrer', (req, res) => {
		  	    let PID = req.body.forPID;
				let Camion = req.body.camId;
				let today = req.body.jour;
				//let today =  new Date().toISOString().split('T')[0]
...
/*####################################[VENTES]#####################################*/
	...
	CafeServeurRouter.post('/mv/resumer', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
				let Today =  new Date().toLocaleDateString('fr-FR').split( '/' ).reverse( ).join( '-' )
				function FetchStock() {
	...
	/* selctioner mes vente auhoudhui */
	CafeServeurRouter.post('/mv/resumer/jour', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
	...
	/* selctioner mes vente auhoudhui */
	CafeServeurRouter.post('/mv/article', (req, res) => {
		   let PID = req.body.forPID
	       let camId = req.body.camId
...
/*####################################[CLIENT]#####################################*/
	...
	CafeServeurRouter.post('/client/reglemment', async function(req, res, next) {
	  	    let PID = req.body.forPID;
			let clientId = req.body.clientId;
...
/*####################################[RECETTE]####################################*/
	/* Ajouter Depense */
	CafeServeurRouter.post('/rt/depense/list', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let camId = req.body.camId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `SELECT * FROM 05_cafe_caisses_depenses WHERE Caisse_ID = ${camId} AND D_Date = '${Today}'`;
				connection.query(sql, (err, rows, fields) => {
				if (err) throw err
				res.json(rows);
	...
	/* Ajouter Depense */
	CafeServeurRouter.post('/rt/depense/ajouter', (req, res) => {
		  	    let PID = req.body.forPID;
				let depD = req.body.depenseD;
				let Today = new Date().toISOString().split('T')[0]
				let camId = req.body.camId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 05_cafe_caisses_depenses (Caisse_ID,Depense,Valeur, Description, D_Date) 
	...
	/* Supprimer Depense */
	CafeServeurRouter.post('/rt/depense/supprimer', (req, res) => {
		  	    let PID = req.body.forPID;
				let ID = req.body.depId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `DELETE FROM 05_cafe_caisses_depenses WHERE PK = ${ID}`;
				connection.query(sql, (err, rows, fields) => {
				if (err) throw err
				res.json({ID:ID});
	...
	/*Imprimer Recette */
	CafeServeurRouter.post('/rt/imprimer', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
		    ...
		    function CalculateRecette() {
			      return new Promise((resolve, reject) => {
			      	...
			      	let sql = `SELECT SUM(Final_Value) AS RCT
			                  FROM  05_cafe_factures WHERE Caisse_ID = ${camionID} AND T_Date = '${Today}' AND State = 'Payee' `;
				       connection.query(sql, (err, rows, fields) => {
				          if (err) return reject(err);
		    ...
		    function CalculateDepense() {
			      return new Promise((resolve, reject) => {
			      	...
			      	let sql = `
			                   ...
			                   FROM 05_cafe_caisses_depenses WHERE Caisse_ID = ${camionID} AND D_Date = '${Today}'`;
				       connection.query(sql, (err, rows, fields) => {
				          if (err) return reject(err);
		    ...
		    function CalculateBons() {
			      return new Promise((resolve, reject) => {
				      	connection.changeUser({database : 'dszrccqg_system'}, () => {});
				      	let sql = `SELECT Paye_Bons  FROM 05_cafe_factures WHERE Caisse_ID = ${camionID} AND T_Date = '${Today}' AND Paye_Bons != ''`; 
				        connection.query(sql, (err, rows, fields) => {
					        if (err){ throw err}
	...
	/*Imprimer Recette */
	CafeServeurRouter.post('/rt/imprimer/temp', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
		    ...
		    function CalculateDepense() {
			      return new Promise((resolve, reject) => {
			      	connection.changeUser({database : 'dszrccqg_system'}, () => {});
			      	let sql = `
			      			   SELECT * FROM 05_cafe_caisses_depenses WHERE Caisse_ID = ${camionID} AND D_Date = '${Today}'`;
				       connection.query(sql, (err, rows, fields) => {
				          if (err) return reject(err);
				          resolve(rows);
	...
	/* Ajouter Depense */
	CafeServeurRouter.post('/rt/factures', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
	...
	/* Ajouter Depense */
	CafeServeurRouter.post('/rt/factures/select', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let FID = req.body.FID;
				let caisseId = req.body.caisseId;
				...
				let sql = `SELECT * , COALESCE(05_cafe_clients.CL_Name, 'PASSAGER') AS CL_Name ,05_cafe_factures.State AS Pay_State FROM 05_cafe_factures 
		                     LEFT JOIN 05_cafe_clients ON 05_cafe_factures.Client = 05_cafe_clients.CL_ID 
		                     LEFT JOIN 05_cafe_caisses ON 05_cafe_factures.Caisse_ID = 05_cafe_caisses.C_ID 
		                     WHERE 05_cafe_factures.Caisse_ID = ${caisseId} AND 05_cafe_factures.T_ID = '${FID}'`;
				connection.query(sql, (err, rows, fields) => {
				if (err) throw err
				res.json(rows);
...
/*####################################[COMMANDES]##################################*/
	/* selectionner tous les 05_cafe_factures */
	CafeServeurRouter.post('/commande/search', (req, res) => {
	        const PID = req.body.forPID;
		    const FID = req.body.FID;
		    let Today = new Date().toISOString().split('T')[0]
	        connection.changeUser({database : 'dszrccqg_system'}, () => {});
	        let sql = `SELECT *  FROM 05_cafe_factures  WHERE T_ID = '${FID}' AND Is_Commande != '' `;
	        connection.query(sql, (err, rows, fields) => {
	        if (err){ throw err}
	        res.json(rows[0]);
	      })
	...
	/* selectionner tous les 05_cafe_factures */
	CafeServeurRouter.post('/commande/verifier', (req, res) => {
	        const PID = req.body.forPID;
		    let Today = new Date().toISOString().split('T')[0]
	        ...
	        let sql = `SELECT * FROM dszrccqg_communications.05_cafe_commande 
                       ...
                       WHERE  dszrccqg_communications.05_cafe_commande.PID = '${PID}' AND ( dszrccqg_communications.05_cafe_commande.State = 'W' OR  dszrccqg_communications.05_cafe_commande.State = 'S') ` ;
	        connection.query(sql, (err, rows, fields) => {
	        if (err){ throw err}
	        res.json(rows);
	      })
	...
	/* selectionner tous les 05_cafe_factures */
	CafeServeurRouter.post('/commande/select', (req, res) => {
	        const PID = req.body.forPID;
...
/*&&&&&&&&&&&&&&&&&[Mettre A Jour]&&&&&&&&&&&&&&*/
  /* fetch main Tools */
	CafeServeurRouter.post('/update', (req, res) => {
	        let PID = req.body.forPID
	        let Today = new Date().toISOString().split('T')[0]
	        function FetchStock() {
			    return new Promise((resolve, reject) => {
		    ...
		    function FetchFacture() {
			    ...
			    return new Promise((resolve, reject) => {
			      	connection.changeUser({database : 'dszrccqg_system'}, () => {});
			      	let sql = `SELECT * FROM 05_cafe_factures WHERE PID = '${PID}'`;
			       connection.query(sql, (err, rows, fields) => {
				       if (err) return reject(err);
				       resolve(rows);
		      		})
...
module.exports = CafeServeurRouter