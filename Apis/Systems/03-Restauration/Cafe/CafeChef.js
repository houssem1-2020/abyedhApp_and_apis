...
const CafeChefRouter = express.Router()
...
/*####################################[LOGIN & LANDING ]###########################*/
	...
	/*log in*/
	CafeChefRouter.post('/LogIn', (req, res) => {
	...
	CafeChefRouter.post('/main/position', (req, res) => {
...
/*####################################[CAISSE SIMPLE ]#############################*/
	...
	CafeChefRouter.post('/nv/stock', (req, res) => {
	...
	CafeChefRouter.post('/nv/ajouter', (req, res) => {
		(async() => {
		  	    let PID = req.body.forPID;
	...
	/* modifier un facture */
	CafeChefRouter.post('/nv/payee/espece', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	CafeChefRouter.post('/nv/payee/bons', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	CafeChefRouter.post('/nv/client/credit', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	CafeChefRouter.post('/nv/client/fidelite', (req, res) => {
		  let PID = req.body.forPID;
		  let clientId = req.body.clientId
		  let FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* modifier un facture */
	CafeChefRouter.post('/nv/openCaisse', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[MES FACT]###################################*/
	...
	CafeChefRouter.post('/mf', (req, res) => {
	...
	CafeChefRouter.post('/mf/select', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
	...
	/* modifier un facture */
	CafeChefRouter.post('/mf/modifier', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[STOCK]######################################*/
	/*Suivie un article */
	CafeChefRouter.post('/sk/suivie', (req, res) => {
		    let PID = req.body.forPID;
	...
	/*Selectionner Fonds */
	CafeChefRouter.post('/sk/fonds', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	CafeChefRouter.post('/sk/fonds/info', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  const FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/*Regler Ventes*/
	CafeChefRouter.post('/sk/reglemment', (req, res) => {
		  let PID = req.body.forPID  
	...
	CafeChefRouter.post('/sk/reglemment/check', (req, res) => {
		  let PID = req.body.forPID;
		  let camId = req.body.camId;
	...
	/*Regler Ventes*/
	CafeChefRouter.post('/sk/reglemment/enregistrer', (req, res) => {
		  	    let PID = req.body.forPID;
				let Camion = req.body.camId;
				let today = req.body.jour;
				//let today =  new Date().toISOString().split('T')[0]
...
/*####################################[VENTES]#####################################*/
	...
	CafeChefRouter.post('/mv/resumer', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
				let Today =  new Date().toLocaleDateString('fr-FR').split( '/' ).reverse( ).join( '-' )
				function FetchStock() {
	...
	/* selctioner mes vente auhoudhui */
	CafeChefRouter.post('/mv/resumer/jour', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
	...
	/* selctioner mes vente auhoudhui */
	CafeChefRouter.post('/mv/article', (req, res) => {
		   let PID = req.body.forPID
	       let camId = req.body.camId
...
/*####################################[CLIENT]#####################################*/
	...
	CafeChefRouter.post('/client/reglemment', async function(req, res, next) {
	  	    let PID = req.body.forPID;
			let clientId = req.body.clientId;
...
/*####################################[RECETTE]####################################*/
	/* Ajouter Depense */
	CafeChefRouter.post('/rt/depense/list', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let camId = req.body.camId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* Ajouter Depense */
	CafeChefRouter.post('/rt/depense/ajouter', (req, res) => {
		  	    let PID = req.body.forPID;
	...
	/* Supprimer Depense */
	CafeChefRouter.post('/rt/depense/supprimer', (req, res) => {
		  	    let PID = req.body.forPID;
	...
	/*Imprimer Recette */
	CafeChefRouter.post('/rt/imprimer', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
	...
	/*Imprimer Recette */
	CafeChefRouter.post('/rt/imprimer/temp', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
	...
	/* Ajouter Depense */
	CafeChefRouter.post('/rt/factures', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
	...
	/* Ajouter Depense */
	CafeChefRouter.post('/rt/factures/select', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let FID = req.body.FID;
				let caisseId = req.body.caisseId;
...
/*####################################[COMMANDES]##################################*/
	...
	CafeChefRouter.post('/commande/search', (req, res) => {
	        const PID = req.body.forPID;
		    const FID = req.body.FID;
		    let Today = new Date().toISOString().split('T')[0]
	        connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* selectionner tous les 05_cafe_factures */
	CafeChefRouter.post('/commande/verifier', (req, res) => {
	        const PID = req.body.forPID;
		    let Today = new Date().toISOString().split('T')[0]
	...
	/* selectionner tous les 05_cafe_factures */
	CafeChefRouter.post('/commande/select', (req, res) => {
	        const PID = req.body.forPID;
...
/*&&&&&&&&&&&&&&&&&[Mettre A Jour]&&&&&&&&&&&&&&*/
  /* fetch main Tools */
	CafeChefRouter.post('/update', (req, res) => {
	        let PID = req.body.forPID
	        let Today = new Date().toISOString().split('T')[0]
	        function FetchStock() {
			    return new Promise((resolve, reject) => {
