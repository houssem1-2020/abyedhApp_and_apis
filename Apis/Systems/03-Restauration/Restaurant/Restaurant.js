...
/*####################################[LOGIN]######################################*/
  ...
  RestaurantRouter.post('/LogIn', (req, res) => {
      ...
      function Connect(){
          ...
          let sql = `SELECT * FROM system_login WHERE Identification = '${logInD.Log}' AND PasswordSalt   = '${logInD.Pwd}' AND SystemKey ='Restaurant'` ;
          connection.query(sql, (err, rows, fields) => {
            if (err) throw err;
            if (rows.length == 0 ) {
...
/*####################################[MAIN]#######################################*/
      ...
      RestaurantRouter.post('/ma/stat', (req, res) => {
              ...
              function NumRowsTable(table,db) {
                return new Promise((resolve, reject) => {
                        connection.changeUser({database : 'dszrccqg_system'}, () => {});
                        let sql = `SELECT PK FROM 05_restaurant_${table} WHERE PID = ${PID}`;
                         connection.query(sql, (err, rows, fields) => {
                          if(err) return reject(err);
                          resolve(rows.length);
                        })
              ...
              function ClientDistrubition() {
                return new Promise((resolve, reject) => {
                        connection.changeUser({database : 'dszrccqg_system'}, () => {});
                        let sql = `SELECT Gouv,COUNT(1) as Totale FROM 05_restaurant_clients  WHERE PID  = '${PID}' GROUP BY Gouv ORDER BY Gouv;`;
                         connection.query(sql, (err, rows, fields) => {
                          if(err) return reject(err);
                          resolve(rows);
                        })
              ...
              function GenreDistrubition() {
                return new Promise((resolve, reject) => {
                        connection.changeUser({database : 'dszrccqg_system'}, () => {});
                        let sql = `SELECT Genre,COUNT(1) as Totale FROM 05_restaurant_menu  WHERE PID  = '${PID}' GROUP BY Genre ORDER BY Genre;`;
                         connection.query(sql, (err, rows, fields) => {
                          if(err) return reject(err);
                          resolve(rows);
                        })
              ...
              function CommandeDistrubition() {
                return new Promise((resolve, reject) => {
                        ...
                        let sql = `SELECT State,COUNT(1) as Totale FROM 05_restaurant_commande  WHERE PID  = '${PID}' GROUP BY State ORDER BY State;`;
                         connection.query(sql, (err, rows, fields) => {
                          if(err) return reject(err);
                          resolve(rows);
                        })
              ...
              function ReservationDistrubition() {
                return new Promise((resolve, reject) => {
                        connection.changeUser({database : 'dszrccqg_communications'}, () => {});
                        let sql = `SELECT State,COUNT(1) as Totale FROM 05_restaurant_reservation  WHERE PID  = '${PID}' GROUP BY State ORDER BY State;`;
                         connection.query(sql, (err, rows, fields) => {
                          if(err) return reject(err);
                          resolve(rows);
                        })
              ...
              function FetchAllCaisses() {
                  return new Promise((resolve, reject) => {
                    connection.changeUser({database : 'dszrccqg_system'}, () => {});
                    let sql = `SELECT *  FROM 05_restaurant_caisses  WHERE PID  = '${PID}' `;
                     connection.query(sql, (err, rows, fields) => {
                        if (err) return reject(err);
                        resolve(rows);
                    })
              ...
              function CalculateRecette(camId) {
                  return new Promise((resolve, reject) => {
                    ...
                    let sql = `SELECT SUM(Final_Value) AS RCT
                               FROM 05_restaurant_factures WHERE  Caisse_ID = ${camId} AND T_Date = '${Today}'   AND  PID  = '${PID}'`;
                     connection.query(sql, (err, rows, fields) => {
                        if (err) return reject(err);
...
/*####################################[REQUEST]####################################*/
      ...
      RestaurantRouter.post('/request', (req, res) => {
          ...
          function FetchCommandes() {
              return new Promise((resolve, reject) => {
                ...
                let sql = `SELECT * FROM dszrccqg_communications.05_restaurant_commande 
                       ...
                       WHERE  dszrccqg_communications.05_restaurant_commande.PID = '${PID}'`;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
          ...
          function FetchReservation(Name) {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_communications'}, () => {});
                let sql = `SELECT * FROM dszrccqg_communications.05_restaurant_reservation 
                       INNER JOIN dszrccqg_profile.user_general_data ON dszrccqg_communications.05_restaurant_reservation.UID = dszrccqg_profile.user_general_data.UID 
                       WHERE  dszrccqg_communications.05_restaurant_reservation.PID = '${PID}'`;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
      ...
      RestaurantRouter.post('/reservation/info', (req, res) => {
            ...
            let sql = `SELECT * FROM dszrccqg_communications.05_restaurant_reservation 
                       INNER JOIN dszrccqg_profile.user_general_data ON dszrccqg_communications.05_restaurant_reservation.UID = dszrccqg_profile.user_general_data.UID 
                       LEFT JOIN dszrccqg_system.05_restaurant_clients ON dszrccqg_communications.05_restaurant_reservation.UID = dszrccqg_system.05_restaurant_clients.Releted_UID
                       WHERE  dszrccqg_communications.05_restaurant_reservation.PID = '${PID}' AND dszrccqg_communications.05_restaurant_reservation.R_ID = '${RID}'`;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
              res.json(rows);
            })
      ...
      RestaurantRouter.post('/commande/controle', (req, res) => {
            ...
            connection.changeUser({database : 'dszrccqg_communications'}, () => {});
            let sql = `UPDATE 05_restaurant_commande
                       SET State = '${State}'
      ...
      RestaurantRouter.post('/reservation/controle', (req, res) => {
            ...
            let State = req.body.state;
            connection.changeUser({database : 'dszrccqg_communications'}, () => {});
            let sql = `UPDATE 05_restaurant_reservation
                       SET State = '${State}'
                       WHERE R_ID = '${R_ID}' AND PID = ${PID}`;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
...
/*####################################[MENU]#######################################*/
    ...
    //fetch all article */
    RestaurantRouter.post('/menu', (req, res) => {
          let PID = req.body.PID;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
    ...
    RestaurantRouter.post('/menu/checkAbyedhDb', (req, res) => {
    ...
    RestaurantRouter.post('/menu/plat', (req, res) => {
            let PID = req.body.PID
            let Code = req.body.code
            function FetchPlatInfo() {
                return new Promise((resolve, reject) => {
                   connection.changeUser({database : 'dszrccqg_system'}, () => {});
                    let sql = `SELECT * FROM 05_restaurant_menu WHERE P_Code = '${Code}' AND PID = ${PID}`;
                   connection.query(sql, (err, rows, fields) => {
                      if (err) return reject(err);
                      resolve(rows[0]);
                  })
            ...
            function FetchInFacture() {
                return new Promise((resolve, reject) => {
                  connection.changeUser({database : 'dszrccqg_system'}, () => {});
                  let sql = `SELECT * FROM 05_restaurant_factures WHERE  Articles LIKE '%${Code}%' AND PID = ${PID}`;
                   connection.query(sql, (err, rows, fields) => {
                      if (err) return reject(err);
                      resolve(rows);
                  })
    ...
    /* ajouter article */
    RestaurantRouter.post('/menu/ajouter', (req, res) => {
          let PID = req.body.PID;
          let articleData = req.body.articleD;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `INSERT INTO 05_restaurant_menu (PID ,P_Code,Name, Prix_vente, Prix_promo,  Cout, Genre,  Repture,  Description, Photo_Path) 
    ...
    /* modifier article  */
    RestaurantRouter.post('/menu/modifier', (req, res) => {
          let PID = req.body.PID
          let articleNData = req.body.articleND
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `UPDATE 05_restaurant_menu
    ...
    /* modifier article  */
    RestaurantRouter.post('/menu/modifier/ingredient', (req, res) => {
          let PID = req.body.PID
    ...
    /* modifier article  */
    RestaurantRouter.post('/menu/modifier/image', (req, res) => {
          let PID = req.body.PID
    ...
    /* supprimer article */
    RestaurantRouter.post('/menu/supprimer', (req, res) => {
          let articleData = req.body.articleD
    ...
    /* fetch familles */
    RestaurantRouter.post('/menu/familleplat', (req, res) => {
          let PID = req.body.PID;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `SELECT * FROM 05_restaurant_menu_genre WHERE PID = '${PID}'`;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
            res.json(rows);
          })
    ...
    /*ajouter famille */
    RestaurantRouter.post('/menu/familles/ajouter', (req, res) => {
        let PID = req.body.PID
        let familleData = req.body.familleD
        connection.changeUser({database : 'dszrccqg_system'}, () => {});
        let sql = `INSERT INTO 05_restaurant_menu_genre (Genre,Description,PID) 
    ...
    /* modifier famille */
    RestaurantRouter.post('/menu/familles/modifier', (req, res) => {
        let PID = req.body.PID
        let familleData = req.body.familleD
        connection.changeUser({database : 'dszrccqg_system'}, () => {});
        let sql = `UPDATE 05_restaurant_menu_genre 
...
/*####################################[STOCK]######################################*/
    ...
    //fetch all article */
    RestaurantRouter.post('/stock', (req, res) => {
          let PID = req.body.PID;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `SELECT * FROM 05_restaurant_articles WHERE PID = '${PID}'`;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
            res.json(rows);
          })
    ...
    //check article in abyedhDB */
    RestaurantRouter.post('/stock/checkAbyedhDb', (req, res) => {
          let Code = req.body.Code;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `SELECT * FROM 000_abyedh_articles WHERE A_Code = '${Code}'`;
           connection.query(sql, (err, rows, fields) => {
   ...
   /* fetach article info  */
    RestaurantRouter.post('/stock/article', (req, res) => {
          let PID = req.body.PID
          let Code = req.body.code
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `SELECT * FROM 05_restaurant_articles WHERE A_Code = '${Code}' AND PID = ${PID}`;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
            res.send(rows);
          })
    ...
    /* ajouter article */
    RestaurantRouter.post('/stock/ajouter', (req, res) => {
          let PID = req.body.PID;
          let articleData = req.body.articleD;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `INSERT INTO 05_restaurant_articles (PID ,A_Code,Name, Quantite,Prix_achat, Genre, Repture,Photo_Path) 
    ...
    /* modifier article  */
    RestaurantRouter.post('/stock/modifier', (req, res) => {
          let PID = req.body.PID
          let articleNData = req.body.articleND
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `UPDATE 05_restaurant_articles
    ...
    /* modifier article  */
    RestaurantRouter.post('/stock/modifier/image', (req, res) => {
          let PID = req.body.PID
          let path = req.body.path
          let Code = req.body.code
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
    ...
    /* supprimer article */
    RestaurantRouter.post('/stock/supprimer', (req, res) => {
          let articleData = req.body.articleD
          // let sql = `INSERT INTO alimentaire_article
          //           (A_Code,Name, Prix_vente, Quantite, Prix_achat, Genre, Socite, Repture, TVA,Groupage,facturable) 
          //           VALUES ('${articleData.A_Code}','${articleData.Name}','${articleData.PrixV}','${articleData.Qte}','${articleData.PrixA}','${articleData.Genre}','${articleData.Socite}','${articleData.Repture}','${articleData.TVA}','${articleData.Groupage}','') `;
...
/*####################################[CAISSE]#####################################*/
      ...
      RestaurantRouter.post('/caisses', (req, res) => {
            let PID = req.body.PID;
            let Today = new Date().toISOString().split('T')[0]
            function FetchAllCaisses() {
                return new Promise((resolve, reject) => {
            ...
            function CalculateRecette(camId) {
                return new Promise((resolve, reject) => {
                  connection.changeUser({database : 'dszrccqg_system'}, () => {});
                  let sql = `SELECT SUM(Final_Value) AS RCT FROM 05_restaurant_factures WHERE PID = ${PID} AND Caisse_ID = ${camId} AND T_Date = '${Today}' `;
                   connection.query(sql, (err, rows, fields) => {
                      if (err) return reject(err);
                      if (rows[0].RCT == null) {resolve('0.000');} else {resolve(rows[0].RCT.toFixed(3));}
      ...
      RestaurantRouter.post('/caisse/info', (req, res) => {
            let PID = req.body.PID;
            ...
            function FetchAllCaisseData() {
                return new Promise((resolve, reject) => {
                  connection.changeUser({database : 'dszrccqg_system'}, () => {});
                  let sql = `SELECT * FROM 05_restaurant_caisses WHERE PID = ${PID} AND C_ID = ${caisseID}`;
                   connection.query(sql, (err, rows, fields) => {
                      if (err) return reject(err);
                      resolve(rows[0]);
                  })
            ...
            function CalculateRecette() {
                return new Promise((resolve, reject) => {
                  connection.changeUser({database : 'dszrccqg_system'}, () => {});
                  let sql = `SELECT SUM(Final_Value) AS RCT FROM 05_restaurant_factures WHERE PID = ${PID} AND  Caisse_ID = ${caisseID} AND T_Date = '${Today}' `;
                   connection.query(sql, (err, rows, fields) => {
                      if (err) return reject(err);
            ...
            function CaisseFactures() {
                return new Promise((resolve, reject) => {
                  connection.changeUser({database : 'dszrccqg_system'}, () => {});
                  let sql = `SELECT * , COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name FROM 05_restaurant_factures 
                             LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID 
                             WHERE 05_restaurant_factures.PID = ${PID} AND  05_restaurant_factures.Caisse_ID = ${caisseID}   LIMIT 200 `;
                   connection.query(sql, (err, rows, fields) => {
                      if (err) return reject(err);
                      resolve(rows);
                  })
      ...
      /*Ajouter Camion*/
      RestaurantRouter.post('/caisses/ajouter', (req, res) => {
          (async() => {
              let PID = req.body.PID
              let caisseData = req.body.caisseD
              let C_ID =   await GenerateID(1111111111,`05_restaurant_caisses`,'C_ID');
              let sql = `INSERT INTO 05_restaurant_caisses (PID, C_ID,CA_Name, Password ,Identifiant, Caisse_Fond) 
      ...
      /* modifier un camion */
      RestaurantRouter.post('/caisses/modifier', (req, res) => {
            let PID = req.body.PID
            let caisseData = req.body.caisseD
            let sql = `UPDATE 05_restaurant_caisses
      ...
      //facture du jour 
      RestaurantRouter.post('/caisse/searchrecette', (req, res) => {
             let PID = req.body.PID
             let caisseID = req.body.camId
             ...
             let sql = `SELECT * , COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name FROM 05_restaurant_factures 
                        LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID 
                        WHERE 05_restaurant_factures.Caisse_ID = ${caisseID}  AND 05_restaurant_factures.T_Date >= '${targetDay.start}' AND 05_restaurant_factures.T_Date <= '${targetDay.end}' `;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
              res.json(rows);
...
/*####################################[FACTURES]###################################*/
    ...
    RestaurantRouter.post('/facture', (req, res) => {
          let PID = req.body.PID;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `SELECT * , COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name ,  COALESCE(05_restaurant_caisses.CA_Name, 'COMMANDE') AS CA_Name ,05_restaurant_factures.State AS Pay_State FROM 05_restaurant_factures 
                     LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID 
                     LEFT JOIN 05_restaurant_caisses ON 05_restaurant_factures.Caisse_ID = 05_restaurant_caisses.C_ID 
                     WHERE 05_restaurant_factures.PID = ${PID} LIMIT 200`;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
    ...
    /* selectionner tous les factures */
    RestaurantRouter.post('/facture/resumer', (req, res) => {
           let PID = req.body.PID
           ...
           let sql = `SELECT * , COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name , COALESCE(05_restaurant_caisses.CA_Name, 'COMMANDE') AS CA_Name ,05_restaurant_factures.State AS Pay_State FROM 05_restaurant_factures 
                     LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID 
                     LEFT JOIN 05_restaurant_caisses ON 05_restaurant_factures.Caisse_ID = 05_restaurant_caisses.C_ID 
                     WHERE 05_restaurant_factures.T_Date >= '${date.start}' AND 05_restaurant_factures.T_Date <= '${date.end}' `;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
              res.json(rows);
            })        
    ...
    RestaurantRouter.post('/facture/select', (req, res) => {
           let PID = req.body.PID
           ...
           let sql = `SELECT 05_restaurant_factures.* , 05_restaurant_clients.*,  05_restaurant_caisses.C_ID, 05_restaurant_caisses.CA_Name, COALESCE(05_restaurant_caisses.CA_Name, 'COMMANDE') AS CA_Name , 05_restaurant_factures.PK AS FACT_ID, 05_restaurant_factures.State AS Pay_State,  COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name
                      ...
                      LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID 
                      LEFT JOIN 05_restaurant_caisses ON 05_restaurant_factures.Caisse_ID = 05_restaurant_caisses.C_ID
                      WHERE 05_restaurant_factures.T_ID = ${FID} `;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
            res.send(rows);
          })         
    ...
    /* modifier un facture */
    RestaurantRouter.post('/facture/modifier', (req, res) => {
           let PID = req.body.PID
    ...
    /* modifier un facture */
    RestaurantRouter.post('/facture/supprimer', (req, res) => {
           let PID = req.body.PID
           let FID = req.body.FID
           connection.changeUser({database : 'dszrccqg_system'}, () => {});
           let sql = `DELETE FROM 05_restaurant_factures WHERE  T_ID = '${FID}' AND PID = ${PID} `;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
            res.json(rows);
          })         
...
/*####################################[TABLES]#####################################*/
      ...
      RestaurantRouter.post('/tables', (req, res) => {
            let PID = req.body.PID;
            connection.changeUser({database : 'dszrccqg_system'}, () => {});
            let sql = `SELECT * FROM 05_restaurant_tables WHERE PID = '${PID}'`;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
              res.json(rows);
            })
      ...
      RestaurantRouter.post('/tables/ajouter', (req, res) => {
            ...
            connection.changeUser({database : 'dszrccqg_system'}, () => {});
            let sql = `INSERT INTO 05_restaurant_tables (PID ,Table_Name,  Table_Num,  Description ) 
      ...
      RestaurantRouter.post('/tables/modifier', (req, res) => {
          ...
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `UPDATE 05_restaurant_tables 
...
/*####################################[CLIENT]#####################################*/
    ...
    RestaurantRouter.post('/client', (req, res) => {
          let PID = req.body.PID;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
    ...
    /* selectioner un client */
    RestaurantRouter.post('/client/info', (req, res) => {
          let PID = req.body.PID;
          let clientID = req.body.clientId
          function FetchClientData() {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_system'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_clients WHERE PID = ${PID} AND CL_ID = ${clientID}`;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    //resolve(rows);
          ...
          function SelectCommandes(Name) {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_communications'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_commande WHERE UID = '${Name}' AND PID = ${PID} `;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
          ...
          function SelectReservation(Name) {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_communications'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_reservation WHERE UID = '${Name}' AND PID = ${PID} `;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
          ...
          function SelectFactures(Name) {
              return new Promise((resolve, reject) => {
                ...
                let sql = `SELECT * , COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name ,05_restaurant_factures.State AS Pay_State FROM 05_restaurant_factures 
                           LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID 
                           LEFT JOIN 05_restaurant_caisses ON 05_restaurant_factures.Caisse_ID = 05_restaurant_caisses.C_ID 
                           WHERE 05_restaurant_factures.PID = ${PID} AND 05_restaurant_factures.Client = '${Name}'  `;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
    ...
    /* selectioner tous les client 
    RestaurantRouter.post('/client/verification/recherche', (req, res) => {
    ...
    //check article in abyedhDB */
    RestaurantRouter.post('/client/checkAbyedhDb', (req, res) => {
          let UID = req.body.UID;
          connection.changeUser({database : 'dszrccqg_profile'}, () => {});
          let sql = `SELECT * FROM user_general_data WHERE UID = '${UID}'`;
           connection.query(sql, (err, rows, fields) => {
    ...
    /* selectioner tous les client */
    RestaurantRouter.post('/client/verification', (req, res) => {
          let PID = req.body.PID;
          let UID = req.body.UID;
          let CL_ID = req.body.CL_ID;
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `UPDATE 05_restaurant_clients
                     SET Releted_UID = ${UID}
    ...
    /* Ajouter client */
    RestaurantRouter.post('/client/ajouter', (req, res) => {
      (async() => {
        let PID = req.body.PID;
        let clientD = req.body.clientD
        let CID = await GenerateID(1111111111,'05_restaurant_clients','CL_ID');
        let Today = new Date().toISOString().split('T')[0]
          let sql = `INSERT INTO 05_restaurant_clients (CL_ID, PID,  Releted_UID,  CL_Name, Creation_Date, Phone, Adress, CIN, CL_State, Gouv, Deleg) 
    ...
    /* modifier un client */
    RestaurantRouter.post('/client/modifier', (req, res) => {
        let PID = req.body.PID;
        let clientD = req.body.clientD
        connection.changeUser({database : 'dszrccqg_system'}, () => {});
        let sql = `UPDATE 05_restaurant_clients
    ...
    RestaurantRouter.post('/client/fidelite', (req, res) => {
           let PID = req.body.PID;
           ...
           connection.changeUser({database : 'dszrccqg_system'}, () => {});
           let sql1 = `SELECT  05_restaurant_factures.Client, SUM(Final_Value) as Totale, 05_restaurant_factures.T_Date , 05_restaurant_clients.CL_Name, 05_restaurant_clients.CL_ID, COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name
                      FROM 05_restaurant_factures 
                      LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID
                      WHERE 05_restaurant_factures.T_Date > '${start}' AND 05_restaurant_factures.T_Date < '${finish}' 
                      GROUP BY 05_restaurant_factures.Client ORDER BY SUM(Final_Value) DESC LIMIT ${top};`

           let sql2 = `SELECT COUNT(1) as Totale , 05_restaurant_factures.Client , 05_restaurant_clients.CL_Name , 05_restaurant_clients.CL_ID, COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name
                      FROM 05_restaurant_factures  
                      LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID
                      WHERE 05_restaurant_factures.T_Date > '${start}' AND 05_restaurant_factures.T_Date < '${finish}'  
                      GROUP BY 05_restaurant_factures.Client ORDER BY COUNT(1) DESC LIMIT ${top};`
...
/*####################################[TEAM]#######################################*/
      ...
      /* selectioner tous l'05_restaurant_team */
      RestaurantRouter.post('/team', (req, res) => {
            let PID = req.body.PID;
            connection.changeUser({database : 'dszrccqg_system'}, () => {});
            let sql = `SELECT *  FROM 05_restaurant_team WHERE PID = ${PID} `;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
              res.send(rows);
            })         
      ...
      RestaurantRouter.post('/team/ajouter', (req, res) => {
        (async() => {
          ...
          let CID = await GenerateID(1111111111,'05_restaurant_team','T_ID');
          let Today = new Date().toISOString().split('T')[0]
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `INSERT INTO 05_restaurant_team (PID, T_ID, T_Name, T_CIN, T_Phone, T_Adress, Poste,  Started_At, Finish_at)
      ...
      RestaurantRouter.post('/team/modifier', (req, res) => {
          ...
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `UPDATE 05_restaurant_team
      ...
      RestaurantRouter.post('/team/info', (req, res) => {
          ...
          function FetchTeamData() {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_system'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_team WHERE T_ID = ${TID} AND PID = ${PID} `;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
          ...
          function SelectPresence(Name) {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_system'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_team_presence WHERE Team_ID = ${TID}  `;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
          ...
          function SelectAvances(Name) {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_system'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_team_avance WHERE Team_ID = ${TID}  `;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
      ...
      RestaurantRouter.post('/team/anavce', (req, res) => {
          ...
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
            let sql = `SELECT * 
                       FROM 05_restaurant_team_avance 
                       LEFT JOIN 05_restaurant_team ON 05_restaurant_team.T_ID =  05_restaurant_team_avance.Team_ID 
                       WHERE PID = ${PID}`;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
              res.json(rows);
      ...
      RestaurantRouter.post('/team/anavce/ajoute', (req, res) => {
          ...
          let Today = new Date().toISOString().split('T')[0]
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
            let sql = `INSERT INTO 05_restaurant_team_avance (Team_ID, AV_Date, Valeur)
      ...
      RestaurantRouter.post('/team/presence', (req, res) => {
          ...
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
            let sql = `SELECT * 
                       FROM 05_restaurant_team_presence 
                       LEFT JOIN 05_restaurant_team ON 05_restaurant_team.T_ID =  05_restaurant_team_presence.Team_ID 
                       WHERE PID = ${PID}`;
             connection.query(sql, (err, rows, fields) => {
              if (err){ throw err}
              res.json(rows);
      ...
      RestaurantRouter.post('/team/presence/ajoute', (req, res) => {
          ...
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
            let sql = `INSERT INTO 05_restaurant_team_presence (Team_ID, PR_Date, Genre)
      ...
      RestaurantRouter.post('/team/poste', (req, res) => {
        let TAG = req.body.PID;
        connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `SELECT * FROM 05_restaurant_team_poste WHERE PID = '${TAG}'`;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
            res.json(rows);
          })
      ...
      RestaurantRouter.post('/team/poste/ajouter', (req, res) => {
          ...
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `INSERT INTO 05_restaurant_team_poste (PID, Poste ,Description,Salaire,Experience_Target) 
      ...
      RestaurantRouter.post('/team/poste/modifier', (req, res) => {
        ...
        let posteD = req.body.posteD
        connection.changeUser({database : 'dszrccqg_system'}, () => {});
        let sql = `UPDATE 05_restaurant_team_poste 
...
/*####################################[FOURNISSEUR]################################*/
    ...
    RestaurantRouter.post('/fournisseur', (req, res) => {
          let PID = req.body.PID
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `SELECT * FROM 05_restaurant_fournisseur WHERE PID = '${PID}'`;
           connection.query(sql, (err, rows, fields) => {
            if (err){ throw err}
            res.json(rows);
          })          
    ...
    RestaurantRouter.post('/fournisseur/info', (req, res) => {
          ...
          function FetchClientData() {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_system'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_fournisseur WHERE Four_ID = ${fourId}`;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    if (!rows[0]) {resolve([{ Name:null , }]);} else {resolve(rows);}
                })
          ...
          function SelectFactureCamion(Name) {
              return new Promise((resolve, reject) => {
                connection.changeUser({database : 'dszrccqg_system'}, () => {});
                let sql = `SELECT * FROM 05_restaurant_caisses_facture WHERE C_Name = '${fourId}' `;
                 connection.query(sql, (err, rows, fields) => {
                    if (err) return reject(err);
                    resolve(rows);
                })
    ...
    RestaurantRouter.post('/fournisseur/ajouter', (req, res) => {
      (async() => {
        ...
        let CID = await GenerateID(1111111111,'05_restaurant_fournisseur','Four_ID');
        let Today = new Date().toISOString().split('T')[0]
        connection.changeUser({database : 'dszrccqg_system'}, () => {});
        let sql = `INSERT INTO 05_restaurant_fournisseur (PID, Releted_PID, Four_ID, Four_Code_Fiscale, Four_Name, Four_Phone, Articles_Genre, Four_Gouv, Four_Deleg, Four_Adress, Jour_Periodique, Four_State, Four_Lng, Four_Lat)
...
/*&&&&&&&&&&&&&&&&&[PROFILE]&&&&&&&&&&&&&&&&&*/
  ...
  RestaurantRouter.post('/profile/update/horaire', (req, res) => {
          ...
          let genre = req.body.genre
          connection.changeUser({database : 'dszrccqg_system'}, () => {});
          let sql = `UPDATE 05_restaurant_setting
                     SET ${genre} = '${settingD}' 
                     WHERE  PID = '${PID}' `;
           connection.query(sql, (err, rows, fields) => {
            if (err){res.json(err)}
...
/*&&&&&&&&&&&&&&&&&[SETTING]&&&&&&&&&&&&&&&&&*/
  ...
  RestaurantRouter.post('/parametre', (req, res) => {
          ...
          function GetSetting() {
            return new Promise((resolve, reject) => {
                    connection.changeUser({database : 'dszrccqg_system'}, () => {});
                    let sql = `SELECT * FROM  05_restaurant_setting WHERE PID = '${PID}';`;
                     connection.query(sql, (err, rows, fields) => {
                      if(err) return reject(err);
                      resolve(rows[0]);
                    })
            ...
            return new Promise((resolve, reject) => {
              connection.changeUser({database : 'dszrccqg_system'}, () => {});
                let sql = `SELECT * , COALESCE(05_restaurant_clients.CL_Name, 'PASSAGER') AS CL_Name ,05_restaurant_factures.State AS Pay_State FROM 05_restaurant_factures 
                           LEFT JOIN 05_restaurant_clients ON 05_restaurant_factures.Client = 05_restaurant_clients.CL_ID 
                           LEFT JOIN 05_restaurant_caisses ON 05_restaurant_factures.Caisse_ID = 05_restaurant_caisses.C_ID 
                           WHERE 05_restaurant_factures.PID = ${PID}`;
               connection.query(sql, (err, rows, fields) => {
                 if (err) return reject(err);
                 resolve(rows);
                })
