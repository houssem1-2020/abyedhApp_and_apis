...
const garderieProfRouter = express.Router()
...
/*####################################[LOGIN & LANDING ]###########################*/
	...
	/*log in*/
	garderieProfRouter.post('/LogIn', (req, res) => {
		  const logInD = req.body.LoginData;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
		  let sql = `SELECT * FROM 02_garderie_caisses WHERE Identifiant = '${logInD.Log}' AND Password  = '${logInD.Pwd}'` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows[0])
	...
	garderieProfRouter.post('/main/position', (req, res) => {
				...
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 02_garderie_caisses_position(Camion_ID,jour,heur,Position) VALUES ('${camId}','${Today}','${ToTime}','${position}') ON DUPLICATE KEY UPDATE jour = '${Today}',  heur = '${ToTime}' , Position = '${position}' ;`;
				connection.query(sql, (err, rows, fields) => {
					if (err) throw err
					res.json(rows);
				}); 
...
/*####################################[CAISSE SIMPLE ]#############################*/
	...
	garderieProfRouter.post('/nv/stock', (req, res) => {
		  const PID = req.body.forPID;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
		  let sql = `SELECT * FROM 02_garderie_menu WHERE PID = '${PID}' ` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows);
	...
	garderieProfRouter.post('/nv/ajouter', (req, res) => {
		(async() => {
		  	    let PID = req.body.forPID;
				let factureD = req.body.factureD;
				let FID = await GenerateID(1111111111,`02_garderie_factures`,'T_ID');
				let articleL = JSON.stringify(factureD.articles)
				let Today = new Date().toLocaleDateString('fr-FR').split( '/' ).reverse( ).join( '-' )
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 02_garderie_factures (PID,T_ID,Cre_Date,Camion,C_Name,Tota, Chauffeur,Articles) 
	...
	garderieProfRouter.post('/nv/ajouter', (req, res) => {
		(async() => {
				...
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 02_garderie_factures (PID, T_ID,Caisse_ID,Final_Value,Espece, T_Date, T_Time,Client,State, Paye_Bons, Articles) 
	...
	/* modifier un facture */
	garderieProfRouter.post('/nv/payee/espece', (req, res) => {
		  let PID = req.body.forPID;
		  let espece = req.body.espece
		  let FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
		  let sql = `UPDATE 02_garderie_factures
	...
	/* modifier un facture */
	garderieProfRouter.post('/nv/payee/bons', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	garderieProfRouter.post('/nv/client/credit', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	garderieProfRouter.post('/nv/client/fidelite', (req, res) => {
		  let PID = req.body.forPID;
		  let clientId = req.body.clientId
		  let FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* modifier un facture */
	garderieProfRouter.post('/nv/openCaisse', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[MES FACT]###################################*/
	...
	/* selctioner mes 02_garderie_factures [in between] */
	garderieProfRouter.post('/mf', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
		  let sql = `SELECT * 
		  			 FROM 02_garderie_factures 
		  			 LEFT JOIN 02_garderie_clients ON 02_garderie_factures.C_Name = 02_garderie_clients.CL_ID
		  			 WHERE 02_garderie_factures.Camion = ${camId} ORDER BY 02_garderie_factures.Cre_Date DESC LIMIT 50` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows);
	...
	/* selectioner une 02_garderie_factures */
	garderieProfRouter.post('/mf/select', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  ...
		  let sql = `SELECT *
		  			 FROM 02_garderie_factures 
		  			 LEFT JOIN 02_garderie_clients ON 02_garderie_factures.C_Name = 02_garderie_clients.CL_ID
		  			 WHERE 02_garderie_factures.Camion =  ${camId}  AND 02_garderie_factures.F_ID = ${FID} ` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows);
	...
	/* modifier un facture */
	garderieProfRouter.post('/mf/modifier', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[STOCK]######################################*/
	/*Suivie un article */
	garderieProfRouter.post('/sk/suivie', (req, res) => {
		    let PID = req.body.forPID;
	...
	/*Selectionner Fonds */
	garderieProfRouter.post('/sk/fonds', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	garderieProfRouter.post('/sk/fonds/info', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  const FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/*Regler Ventes*/
	garderieProfRouter.post('/sk/reglemment', (req, res) => {
		  let PID = req.body.forPID  
	...
	garderieProfRouter.post('/sk/reglemment/check', (req, res) => {
		  let PID = req.body.forPID;
		  let camId = req.body.camId;
	...
	/*Regler Ventes*/
	garderieProfRouter.post('/sk/reglemment/enregistrer', (req, res) => {
		  	    let PID = req.body.forPID;
				let Camion = req.body.camId;
				let today = req.body.jour;
				//let today =  new Date().toISOString().split('T')[0]
...
/*####################################[VENTES]#####################################*/
	...
	garderieProfRouter.post('/mv/resumer', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
				let Today =  new Date().toLocaleDateString('fr-FR').split( '/' ).reverse( ).join( '-' )
				function FetchStock() {
	...
	/* selctioner mes vente auhoudhui */
	garderieProfRouter.post('/mv/resumer/jour', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
	...
	/* selctioner mes vente auhoudhui */
	garderieProfRouter.post('/mv/article', (req, res) => {
		   let PID = req.body.forPID
	       let camId = req.body.camId
...
/*####################################[CLIENT]#####################################*/
	...
	garderieProfRouter.post('/client/reglemment', async function(req, res, next) {
	  	    let PID = req.body.forPID;
			let clientId = req.body.clientId;
...
/*####################################[RECETTE]####################################*/
	/* Ajouter Depense */
	garderieProfRouter.post('/rt/depense/list', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let camId = req.body.camId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `SELECT * FROM 02_garderie_caisses_depenses WHERE Caisse_ID = ${camId} AND D_Date = '${Today}'`;
				connection.query(sql, (err, rows, fields) => {
				if (err) throw err
				res.json(rows);
	...
	/* Ajouter Depense */
	garderieProfRouter.post('/rt/depense/ajouter', (req, res) => {
		  	    let PID = req.body.forPID;
				let depD = req.body.depenseD;
				let Today = new Date().toISOString().split('T')[0]
				let camId = req.body.camId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `INSERT INTO 02_garderie_caisses_depenses (Caisse_ID,Depense,Valeur, Description, D_Date) 
	...
	/* Supprimer Depense */
	garderieProfRouter.post('/rt/depense/supprimer', (req, res) => {
		  	    let PID = req.body.forPID;
				let ID = req.body.depId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `DELETE FROM 02_garderie_caisses_depenses WHERE PK = ${ID}`;
				connection.query(sql, (err, rows, fields) => {
				if (err) throw err
				res.json({ID:ID});
	...
	/*Imprimer Recette */
	garderieProfRouter.post('/rt/imprimer', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
		    ...
		    function CalculateRecette() {
			      return new Promise((resolve, reject) => {
			      	...
			      	let sql = `SELECT SUM(Final_Value) AS RCT
			                  FROM  02_garderie_factures WHERE Caisse_ID = ${camionID} AND T_Date = '${Today}' AND State = 'Payee' `;
				       connection.query(sql, (err, rows, fields) => {
				          if (err) return reject(err);
		    ...
		    function CalculateDepense() {
			      return new Promise((resolve, reject) => {
			      	...
			      	let sql = `
			                   ...
			                   FROM 02_garderie_caisses_depenses WHERE Caisse_ID = ${camionID} AND D_Date = '${Today}'`;
				       connection.query(sql, (err, rows, fields) => {
				          if (err) return reject(err);
		    ...
		    function CalculateBons() {
			      return new Promise((resolve, reject) => {
				      	connection.changeUser({database : 'dszrccqg_system'}, () => {});
				      	let sql = `SELECT Paye_Bons  FROM 02_garderie_factures WHERE Caisse_ID = ${camionID} AND T_Date = '${Today}' AND Paye_Bons != ''`; 
				        connection.query(sql, (err, rows, fields) => {
					        if (err){ throw err}
	...
	/*Imprimer Recette */
	garderieProfRouter.post('/rt/imprimer/temp', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
		    ...
		    function CalculateDepense() {
			      return new Promise((resolve, reject) => {
			      	connection.changeUser({database : 'dszrccqg_system'}, () => {});
			      	let sql = `
			      			   SELECT * FROM 02_garderie_caisses_depenses WHERE Caisse_ID = ${camionID} AND D_Date = '${Today}'`;
				       connection.query(sql, (err, rows, fields) => {
				          if (err) return reject(err);
				          resolve(rows);
	...
	/* Ajouter Depense */
	garderieProfRouter.post('/rt/factures', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let caisseId = req.body.caisseId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
				let sql = `SELECT * , COALESCE(02_garderie_clients.CL_Name, 'PASSAGER') AS CL_Name , 02_garderie_factures.State AS Pay_State FROM 02_garderie_factures 
		                     LEFT JOIN 02_garderie_clients ON 02_garderie_factures.Client = 02_garderie_clients.CL_ID 
		                     LEFT JOIN 02_garderie_caisses ON 02_garderie_factures.Caisse_ID = 02_garderie_caisses.C_ID 
	...
	/* Ajouter Depense */
	garderieProfRouter.post('/rt/factures/select', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let FID = req.body.FID;
				let caisseId = req.body.caisseId;
				...
				let sql = `SELECT * , COALESCE(02_garderie_clients.CL_Name, 'PASSAGER') AS CL_Name ,02_garderie_factures.State AS Pay_State FROM 02_garderie_factures 
		                     LEFT JOIN 02_garderie_clients ON 02_garderie_factures.Client = 02_garderie_clients.CL_ID 
		                     LEFT JOIN 02_garderie_caisses ON 02_garderie_factures.Caisse_ID = 02_garderie_caisses.C_ID 
		                     WHERE 02_garderie_factures.Caisse_ID = ${caisseId} AND 02_garderie_factures.T_ID = '${FID}'`;
				connection.query(sql, (err, rows, fields) => {
				if (err) throw err
				res.json(rows);
...
/*####################################[COMMANDES]##################################*/
	/* selectionner tous les 02_garderie_factures */
	garderieProfRouter.post('/commande/search', (req, res) => {
	        const PID = req.body.forPID;
		    const FID = req.body.FID;
		    let Today = new Date().toISOString().split('T')[0]
	        connection.changeUser({database : 'dszrccqg_system'}, () => {});
	        let sql = `SELECT *  FROM 02_garderie_factures  WHERE T_ID = '${FID}' AND Is_Commande != '' `;
	        connection.query(sql, (err, rows, fields) => {
	        if (err){ throw err}
	        res.json(rows[0]);
	      })
	...
	/* selectionner tous les 02_garderie_factures */
	garderieProfRouter.post('/commande/verifier', (req, res) => {
	        const PID = req.body.forPID;
		    let Today = new Date().toISOString().split('T')[0]
	        ...
	        let sql = `SELECT * FROM dszrccqg_communications.02_garderie_commande 
                       ...
                       WHERE  dszrccqg_communications.02_garderie_commande.PID = '${PID}' AND ( dszrccqg_communications.02_garderie_commande.State = 'W' OR  dszrccqg_communications.02_garderie_commande.State = 'S') ` ;
	        connection.query(sql, (err, rows, fields) => {
	        if (err){ throw err}
	        res.json(rows);
	      })
	...
	/* selectionner tous les 02_garderie_factures */
	garderieProfRouter.post('/commande/select', (req, res) => {
	        const PID = req.body.forPID;
	        ...
	        let sql = `SELECT * FROM dszrccqg_communications.02_garderie_commande 
                       INNER JOIN dszrccqg_profile.user_general_data ON dszrccqg_communications.02_garderie_commande.UID = dszrccqg_profile.user_general_data.UID 
                       LEFT JOIN dszrccqg_system.02_garderie_clients ON dszrccqg_communications.02_garderie_commande.UID = dszrccqg_system.02_garderie_clients.Releted_UID 
                       WHERE  dszrccqg_communications.02_garderie_commande.PID = '${PID}' AND dszrccqg_communications.02_garderie_commande.R_ID = '${RID}'` ;
	        connection.query(sql, (err, rows, fields) => {
	        if (err){ throw err}
	        res.json(rows);
	      })
...
/*&&&&&&&&&&&&&&&&&[Mettre A Jour]&&&&&&&&&&&&&&*/
  /* fetch main Tools */
	garderieProfRouter.post('/update', (req, res) => {
	        let PID = req.body.forPID
	        let Today = new Date().toISOString().split('T')[0]
	        function FetchStock() {
			    return new Promise((resolve, reject) => {
		    ...
		    function FetchFacture() {
			    ...
			    return new Promise((resolve, reject) => {
			      	connection.changeUser({database : 'dszrccqg_system'}, () => {});
			      	let sql = `SELECT * FROM 02_garderie_factures WHERE PID = '${PID}'`;
			       connection.query(sql, (err, rows, fields) => {
				       if (err) return reject(err);
				       resolve(rows);
		      		})
		    ...
		    function FetchClient() {
			    ...
			    return new Promise((resolve, reject) => {
			      	connection.changeUser({database : 'dszrccqg_system'}, () => {});
			      	let sql = `SELECT * FROM 02_garderie_clients WHERE PID = '${PID}'`;
			       connection.query(sql, (err, rows, fields) => {
				       if (err) return reject(err);
				       resolve(rows);
		      		})
...
module.exports = garderieProfRouter