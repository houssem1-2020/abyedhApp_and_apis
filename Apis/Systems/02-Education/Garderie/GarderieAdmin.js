...
const RestaurantServeurRouter = express.Router()
...
/*####################################[LOGIN & LANDING ]###########################*/
	...
	/*log in*/
	RestaurantServeurRouter.post('/LogIn', (req, res) => {
		  const logInD = req.body.LoginData;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
		  let sql = `SELECT * FROM 05_restaurant_team WHERE Identifiant = '${logInD.Log}' AND Password  = '${logInD.Pwd}'` ;
		  connection.query(sql, (err, rows, fields) => {
		    if (err) throw err
		    res.json(rows[0])
	...
	RestaurantServeurRouter.post('/main/position', (req, res) => {
...
/*####################################[CAISSE SIMPLE ]#############################*/
	...
	RestaurantServeurRouter.post('/nv/stock', (req, res) => {
	...
	RestaurantServeurRouter.post('/nv/ajouter', (req, res) => {
		(async() => {
		  	    let PID = req.body.forPID;
	...
	/* modifier un facture */
	RestaurantServeurRouter.post('/nv/payee/espece', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	RestaurantServeurRouter.post('/nv/payee/bons', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	RestaurantServeurRouter.post('/nv/client/credit', (req, res) => {
		  let PID = req.body.forPID;
	...
	/* modifier un facture */
	RestaurantServeurRouter.post('/nv/client/fidelite', (req, res) => {
		  let PID = req.body.forPID;
		  let clientId = req.body.clientId
		  let FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* modifier un facture */
	RestaurantServeurRouter.post('/nv/openCaisse', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[MES FACT]###################################*/
	...
	RestaurantServeurRouter.post('/mf', (req, res) => {
	...
	RestaurantServeurRouter.post('/mf/select', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
	...
	/* modifier un facture */
	RestaurantServeurRouter.post('/mf/modifier', (req, res) => {
		  let PID = req.body.forPID;
...
/*####################################[STOCK]######################################*/
	/*Suivie un article */
	RestaurantServeurRouter.post('/sk/suivie', (req, res) => {
		    let PID = req.body.forPID;
	...
	/*Selectionner Fonds */
	RestaurantServeurRouter.post('/sk/fonds', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	RestaurantServeurRouter.post('/sk/fonds/info', (req, res) => {
		  const TAG = req.body.tag;
		  const camId = req.body.camId;
		  const FID = req.body.fid;
		  connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/*Regler Ventes*/
	RestaurantServeurRouter.post('/sk/reglemment', (req, res) => {
		  let PID = req.body.forPID  
	...
	RestaurantServeurRouter.post('/sk/reglemment/check', (req, res) => {
		  let PID = req.body.forPID;
		  let camId = req.body.camId;
	...
	/*Regler Ventes*/
	RestaurantServeurRouter.post('/sk/reglemment/enregistrer', (req, res) => {
		  	    let PID = req.body.forPID;
				let Camion = req.body.camId;
				let today = req.body.jour;
				//let today =  new Date().toISOString().split('T')[0]
...
/*####################################[VENTES]#####################################*/
	...
	RestaurantServeurRouter.post('/mv/resumer', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
				let Today =  new Date().toLocaleDateString('fr-FR').split( '/' ).reverse( ).join( '-' )
				function FetchStock() {
	...
	/* selctioner mes vente auhoudhui */
	RestaurantServeurRouter.post('/mv/resumer/jour', (req, res) => {
				let PID = req.body.forPID
				let camId = req.body.camId
	...
	/* selctioner mes vente auhoudhui */
	RestaurantServeurRouter.post('/mv/article', (req, res) => {
		   let PID = req.body.forPID
	       let camId = req.body.camId
...
/*####################################[CLIENT]#####################################*/
	...
	RestaurantServeurRouter.post('/client/reglemment', async function(req, res, next) {
	  	    let PID = req.body.forPID;
			let clientId = req.body.clientId;
...
/*####################################[RECETTE]####################################*/
	/* Ajouter Depense */
	RestaurantServeurRouter.post('/rt/depense/list', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let camId = req.body.camId;
				connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* Ajouter Depense */
	RestaurantServeurRouter.post('/rt/depense/ajouter', (req, res) => {
		  	    let PID = req.body.forPID;
	...
	/* Supprimer Depense */
	RestaurantServeurRouter.post('/rt/depense/supprimer', (req, res) => {
		  	    let PID = req.body.forPID;
	...
	/*Imprimer Recette */
	RestaurantServeurRouter.post('/rt/imprimer', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
	...
	/*Imprimer Recette */
	RestaurantServeurRouter.post('/rt/imprimer/temp', (req, res) => {
		    let PID = req.body.forPID;
		    let camionID = req.body.camId;
		    let Today = new Date().toISOString().split('T')[0]
	...
	/* Ajouter Depense */
	RestaurantServeurRouter.post('/rt/factures', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
	...
	/* Ajouter Depense */
	RestaurantServeurRouter.post('/rt/factures/select', (req, res) => {   
		  	    let PID = req.body.forPID;
				let Today = new Date().toISOString().split('T')[0]
				let FID = req.body.FID;
				let caisseId = req.body.caisseId;
...
/*####################################[COMMANDES]##################################*/
	...
	RestaurantServeurRouter.post('/commande/search', (req, res) => {
	        const PID = req.body.forPID;
		    const FID = req.body.FID;
		    let Today = new Date().toISOString().split('T')[0]
	        connection.changeUser({database : 'dszrccqg_system'}, () => {});
	...
	/* selectionner tous les 05_restaurant_factures */
	RestaurantServeurRouter.post('/commande/verifier', (req, res) => {
	        const PID = req.body.forPID;
		    let Today = new Date().toISOString().split('T')[0]
	...
	/* selectionner tous les 05_restaurant_factures */
	RestaurantServeurRouter.post('/commande/select', (req, res) => {
	        const PID = req.body.forPID;
...
/*&&&&&&&&&&&&&&&&&[Mettre A Jour]&&&&&&&&&&&&&&*/
  /* fetch main Tools */
	RestaurantServeurRouter.post('/update', (req, res) => {
	        let PID = req.body.forPID
	        let Today = new Date().toISOString().split('T')[0]
	        function FetchStock() {
			    return new Promise((resolve, reject) => {
...
module.exports = RestaurantServeurRouter