...
function PublicPage() {
    /* ###########################[const]############################ */
    const Items = [
        {id:2, size:4 , link:'InterGouv',  icon:'dash-square-fill text-danger',  iconColor:'#04c6ce', text:'بين الولايات ', smallText:'أوقات سفر جميع انواع الحافلات, ...'},
        {id:2, size:4 , link:'dansGouv',  icon:'dash-square-fill text-primary',  iconColor:'#04c6ce', text:'داخل الولايات', smallText:'أوقات سفر جميع انواع الحافلات, ...'},
        {id:2, size:4 , link:'dansDeleg',  icon:'dash-square-fill text-warning',  iconColor:'#04c6ce', text:'نقل ريفي ', smallText:'أوقات سفر جميع انواع الحافلات, ...'},
    ]
