...
const GConf = {
    ...
    Tools:{
        ...
        Renting:{themeColor:'#6f92d9', imgAds:'' , textAds:'التطبيق هذا هي وجهة محطات النقل البري علي الانترنت , تعطيك جميع المعلومات علي الرحلات المتوفرة و تمكنك من إنك تحجز مكانك في الرحلة باش ترتحك من برشا تعب و تضييع وقت و جهد ...'},
        ...
        art:{themeColor:'#d469b9', imgAds:'' , textAds:'التطبيق هذا عبارة عن موسوعة شاملة لمختلف العلميات الأدراية التونسيسة و كيفاش تتم العمليات هاذي باش ترتح المواطنين من الحيرة اللي دور في ريوسهم و تعاونهم باش يجاوبو علي مختلف تساءلاتهم'},
        products:{themeColor:'#d91a33', imgAds:'' , textAds:'التطبيق هذا عبارة عن موسوعة شاملة لمختلف العلميات الأدراية التونسيسة و كيفاش تتم العمليات هاذي باش ترتح المواطنين من الحيرة اللي دور في ريوسهم و تعاونهم باش يجاوبو علي مختلف تساءلاتهم'},
        sport:{themeColor:'#8dd673', imgAds:'' , textAds:'التطبيق هذا عبارة عن موسوعة شاملة لمختلف العلميات الأدراية التونسيسة و كيفاش تتم العمليات هاذي باش ترتح المواطنين من الحيرة اللي دور في ريوسهم و تعاونهم باش يجاوبو علي مختلف تساءلاتهم'},
        ...
        news:{themeColor:'#a30b4b', imgAds:'' , textAds:'التطبيق هذا عبارة عن موسوعة شاملة لمختلف وسائل النقل العمومي التونسية , تحتوي أوقات جميع الوسائل من قطار و حافلة و مترو و طائرة ...بالإظافة إلي خريطة الرحلات و متتبع يعطيك مكان الوسيلة علي الخريطة'},
        data:{themeColor:'#04c6ce', imgAds:'' , textAds:'التطبيق هذا عبارة عن موسوعة شاملة لمختلف وسائل النقل العمومي التونسية , تحتوي أوقات جميع الوسائل من قطار و حافلة و مترو و طائرة ...بالإظافة إلي خريطة الرحلات و متتبع يعطيك مكان الوسيلة علي الخريطة'},
    },
}
