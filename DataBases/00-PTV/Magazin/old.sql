...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2023 at 02:30 PM
...
--
-- Table structure for table `05_magazin_caisses_fond`
--

CREATE TABLE `05_magazin_caisses_fond` (
  `PK` bigint(20) NOT NULL,
  `PID` bigint(10) NOT NULL,
...
--
-- Indexes for table `05_magazin_caisses_fond`
--
ALTER TABLE `05_magazin_caisses_fond`
  ADD PRIMARY KEY (`PK`);
...
--
-- AUTO_INCREMENT for table `05_magazin_caisses_fond`
--
ALTER TABLE `05_magazin_caisses_fond`
